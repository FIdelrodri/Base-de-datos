...
<body>
    ...
    <div class="contenedor-fondo">
        ...
        <div class="conteiner_de_productos">
            <?php
              include("../../metodos/conexion.php");
                ...
                $resultado = mysqli_query($conexion, "SELECT * FROM publicacion where id_autor=$id_usuario_producto");
        ...
        <h5> <a href="../../metodos/borrar_todos_tus_productos">Borrar Todos Tus Productos <a></h5>
    </div>
