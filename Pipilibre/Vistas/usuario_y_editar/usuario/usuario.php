    ...
    <div class="container-profile">
        ...
        <div class="profile-addresses">
            ...
            <?php
                ...
                $consulta = mysqli_query($conexion, "SELECT * FROM direccion where id_usuario = $id_usuario_producto");
            ...
            <div class="container">
                ...
                <div class="eliminar_direccion">
                    <form action="../../metodos/procesar_compra.php" method="POST">
                        <input type="hidden" name="id_producto_comprado" value="<?php echo $fila['id_direccion']; ?>">
